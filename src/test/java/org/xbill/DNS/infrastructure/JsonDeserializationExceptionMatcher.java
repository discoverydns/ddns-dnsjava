...
public class JsonDeserializationExceptionMatcher extends
        BaseMatcher<JsonDeserializationException> {
    private JsonDeserializationExceptionCode exceptionCode;
    private Object[] arguments;
    private Class<? extends Throwable> causeClass;
    private Throwable cause;

    public JsonDeserializationExceptionMatcher(
    ...
    public boolean matches(Object item) {
        if (item == null
            || !JsonDeserializationException.class.isAssignableFrom(item.getClass())) {
            return false;
        }
        JsonDeserializationException exception = (JsonDeserializationException) item;
